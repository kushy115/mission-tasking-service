...
def profile() -> DroneProfile:
    return DroneProfile(
        profile_id="t", rated_endurance_s=1800.0, cruise_speed_mps=15.0,
        climb_rate_mps=3.0, battery_wh=300.0, cruise_power_w=300.0,
        hover_power_w=400.0,
...
def _plan() -> MissionPlan:
    return MissionPlan(
        mission_id="m", area_id="t", status=MissionStatus.READY_FOR_APPROVAL,
        legs=[
            MissionLeg(
